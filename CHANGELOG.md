...
* Initial release: `HtmlSearchHighlighter` for clean/normalize/search HTML,
  `HtmlPagedSearchReader` widget with paging, match navigation, and
  `<mark>` styling for `flutter_html`.
